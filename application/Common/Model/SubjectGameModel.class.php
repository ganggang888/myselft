...
class SubjectGameModel extends CommonModel
{
	...
	private function getSay($weight,$height,$header,$bmi,$sex,$month,$type,$array)
	{
		switch ($type) {
			case 1:
				$score = $height / $array['p97'];
				$num = sprintf("%.2f",($score * 100));
				if ($score <= 0.03 ) {
					$message = "宝宝本次身长测评百分位数为".$num."%。在同龄宝宝中，宝宝的身高处于异常水平，请带宝宝到正规的儿科医院做综合的检查和评估！";
				} elseif ($score > 0.03 && $score < 0.25) {
					$message = "宝宝本次身长测评百分位数为".$num."%。在同龄宝宝中，宝宝的身高处于中等偏下水平，请结合BMI指标判断是否需要干预！";
				} elseif ($score >= 0.25 && $score < 0.75) {
					$message = "宝宝本次身长测评百分位数为".$num."%。在同龄宝宝中，宝宝的身高处于中等水平，发育正常！";
				} elseif ($score >= 0.75 && $score < 0.97) {
					$message = "宝宝本次身长测评百分位数为".$num."%。在同龄宝宝中，宝宝的身高处于中等偏上水平，请结合BMI指标判断是否需要干预！";
				} else {
					$message = "宝宝本次身长测评百分位数为".$num."%。在同龄宝宝中，宝宝的身高处于超常水平，请带宝宝到正规的儿科医院做综合的检查和评估！";
				}

				# code...
				break;
			case 2:
				$score = $weight / $array['p97'];
				$num = sprintf("%.2f",($score * 100));
				if ($score <= 0.03 ) {
					$message = "宝宝本次体重测评百分位数为".$num."%。在同龄宝宝中，宝宝的体重处于异常水平，请带宝宝到正规的儿科医院做综合的检查和评估！";
				} elseif ($score > 0.03 && $score < 0.25) {
					$message = "宝宝本次体重测评百分位数为".$num."%。在同龄宝宝中，宝宝的体重处于中等偏下水平，请结合BMI指标判断是否需要干预！";
				} elseif ($score >= 0.25 && $score < 0.75) {
					$message = "宝宝本次体重测评百分位数为".$num."%。在同龄宝宝中，宝宝的体重处于中等水平，发育正常！";
				} elseif ($score >= 0.75 && $score < 0.97) {
					$message = "宝宝本次体重测评百分位数为".$num."%。在同龄宝宝中，宝宝的身高处于中等偏上水平，请结合BMI指标判断是否需要干预！";
				} else {
					$message = "宝宝本次体重测评百分位数为".$num."。在同龄宝宝中，宝宝的体重处于超常水平，请带宝宝到正规的儿科医院做综合的检查和评估！";
				}
				break;
			case 3:
				$score = $bmi / $array['p95'];
				$num = sprintf("%.2f",($score * 100));
				if ($score <= 0.03 ) {
					$message = "宝宝本次测评的BMI百分位数为".$num."%。综合身高、体重发育指标，宝宝的体型处于严重消瘦水平，请带宝宝到正规的儿科医院做综合的检查和评估！";
				} elseif ($score > 0.03 && $score < 0.15) {
					$message = "宝宝本次测评的BMI百分位数为".$num."%。综合身高、体重发育指标，宝宝的体型处于消瘦水平，请带宝宝到正规的儿科医院做综合的检查和评估！";
				} elseif ($score >= 0.15 && $score < 0.85) {
					$message = "宝宝本次测评的BMI百分位数为".$num."%。综合身高、体重发育指标，宝宝的体型处于正常水平，发育良好！";
				} elseif ($score >= 0.85 && $score < 0.95) {
					$message = "宝宝本次测评的BMI百分位数为".$num."%。综合身高、体重发育指标，宝宝的体型处于超重水平，请带宝宝到正规的儿科医院做综合的检查和评估！";
				} else {
					$message = "宝宝本次测评的BMI百分位数为".$num."%。综合身高、体重发育指标，宝宝的体型处于肥胖水平，请带宝宝到正规的儿科医院做综合的检查和评估！";
				}
				break;
			case 4:
				if ($header >= $array['two'] && $header <= $array['four']) {
					$message = "宝宝本次头围测评结果为".$header."。宝宝头围处于正常值范围，发育正常！";
				} elseif ($header < $array['two']) {
					$message = "宝宝本次头围测评结果为".$header."。宝宝头围偏小，提示有脑发育不良的可能，建议去正规的儿科医院做进一步检查！";
				} elseif ($header <= $array['one']) {
					$message = "宝宝本次头围测评结果为".$header."。宝宝头围偏小，提示脑发育不良，建议去正规的儿科医院做进一步检查";
				} elseif ($header > $array['four']) {
					$message = "宝宝本次头围测评结果为".$header."。宝宝头围偏大，提示有脑积水或其它疾病的可能，建议去正规的儿科医院做进一步检查！";
				} elseif ($header >= $array['five']) {
					$message = "宝宝本次头围测评结果为".$header."。宝宝头围偏大，提示有脑积水或其它疾病，建议去正规的儿科医院做进一步检查！";
				}
				break;
			default:
				# code...
