...
<head>
   ...
   *{margin: 0;padding: 0;}
   html,body{width: 100%;height: 100%;}
     .contain{background: url(/info/tpl/simplebootx/Public/img/snow_bg.jpg) top center;background-size: cover;width: 100%;height: 95%;color: #fff;}
...
<header class="color1">
 ...
 <div class="contain">
   <div class="tq_box clearfix">
     ...
     <img src="/info/tpl/simplebootx/Public/img/snow_t.png" class="rain_t">
   </div>
   <div class="tq_info">
   <div class="tq_iinner">
