...
<body class="J_scroll_fixed">
	<div class="wrap jj">
		<ul class="nav nav-tabs">
			<li><a href="<?php echo U('ad/index');?>">短信列表</a></li>
			<li class="active"><a href="<?php echo U('ad/add');?>">添加短信</a></li>
		</ul>
				...
				<fieldset>
					<div class="control-group">
						...
						<div class="controls">
							...
							<span class="must_red">管理员审核的时候会进行核实</span>
						</div>
					</div>
					<div class="control-group">
                    ...
                    <div class="control-group">
						...
						<div class="controls">
							<textarea name="content" rows="5" cols="57"></textarea><span class="must_red">用户名称请用<a>(username)</a>进行代替</span>
						</div>
					</div>
				</fieldset>
				<div class="form-actions">
					<button type="submit" class="btn btn-primary btn_submit J_ajax_submit_btn">添加</button>
					<a class="btn" href="/info/index.php/Admin/User">返回</a>
				</div>
			</form>
		</div>
	</div>
