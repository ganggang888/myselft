...
<html>
	<head>
		...
		<link href="/info/tpl_admin/simpleboot/assets/css/admin_login.css" rel="stylesheet" />
		<style>
			#login_btn_wraper{
				text-align: center;
			}
...
<body>
	<div class="wrap">
		<h1><a style="background:none;text-indent:1em; margin-bottom:-10px; color:#FFF">麦忒管理后台</a></h1>
