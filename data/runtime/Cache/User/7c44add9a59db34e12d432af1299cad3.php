...
<body class="J_scroll_fixed">
	<div class="wrap jj">
                ...
                <div class="control-group">
						...
						<div class="controls">
                         ...
                         <option value="0">请选择分类</option>
							<?php if(is_array($term)): foreach($term as $key=>$vo): ?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["term_name"]); ?></option><?php endforeach; endif; ?>
                            </select>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" class="input" name="title" value="" style="width:50%">
							<span class="must_red">*</span>
						</div>
					</div>
					<div class="control-group">
                    ...
                    <?php if($type == 0): ?><div class="control-group">
						...
						<div class="controls">
							<textarea name="link" rows="5"></textarea>
							<span class="must_red">*</span>
						</div>
					</div><?php endif; ?>
                    <div class="control-group">
      ...
      <img src='/info/statics/images/icon/upload-pic.png' id='thumb_preview' width='135' height='113' style='cursor:hand' /></a>
              ...
              <script type="text/plain" id="content" name="content"><?php echo ($info["content"]); ?></script>
                ...
                <script type="text/javascript"  src="/info/statics/js/ueditor/ueditor.all.min.js"></script>
                    ...
                    <div class="control-group">
						...
						<div class="controls">
							<input type="text" name="add_time" class="input J_datetime">
							<span class="must_red">*</span>
						</div>
					</div>
