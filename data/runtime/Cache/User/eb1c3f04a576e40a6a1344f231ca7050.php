...
<body class="J_scroll_fixed">
	<div class="wrap J_check_wrap">
		<ul class="nav nav-tabs">
			<li class="active"><a href="javascript:;">题目分类</a></li>
            <li><a href="<?php echo U('Subject/addTerm');?>">添加分类</a></li>
		</ul>
		...
		<form class="form-horizontal J_ajaxForm" action="" method="post">
			<table class="table table-hover table-bordered">
				...
				<?php if(is_array($result)): foreach($result as $key=>$vo): ?><tr>
                    ...
                    <td>
                    <a href="<?php echo U('Subject/editTerm',array('id'=>$vo['id']));?>">修改</a> | <a href="<?php echo U('Subject/deleteTerm',array('id'=>$vo['id']));?>" class="J_ajax_del">删除</a>
					</td>
