...
<body class="J_scroll_fixed">
	<div class="wrap J_check_wrap">
		<ul class="nav nav-tabs">
            ...
            <li><a href="<?php echo U('Beautiful/add');?>">添加学员</a></li>
		</ul>
			...
			<div class="search_type cc mb10">
				<div class="mb10">
					<span class="mr20">
						...
						地址：
						<input type="text" name="address" id="address" style="width: 200px;" value="<?php echo ($address); ?>" placeholder="请输入地址...">
						 --
                        分类：
					...
					function todo() {
						...
						window.location.href='index.php?g=User&m=Beautiful&a=index&menuid=185&name='+name+'&address='+address+'&term_id='+term_id;
					}
					</script>
				</div>
			</div>
		...
		<form class="form-horizontal J_ajaxForm" action="" method="post">
			<table class="table table-hover table-bordered">
				...
				<?php if(is_array($result)): foreach($result as $key=>$vo): ?><tr>
                    ...
                    <td>
                    <a href="<?php echo U('Beautiful/edit',array('id'=>$vo['id']));?>">修改</a>
                    |
                    <a class="J_ajax_del" href="<?php echo U('Beautiful/delete',array('id'=>$vo['id']));?>">删除</a>
                    </td>
