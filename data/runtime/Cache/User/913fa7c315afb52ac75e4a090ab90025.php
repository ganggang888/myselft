...
<div class="wrap J_check_wrap">
  <ul class="nav nav-tabs">
     ...
     <li class="active"><a href="javascript:;"  target="_self">添加库</a></li>
  </ul>
  <form name="myform" id="myform" action="<?php echo u('Default/add_store_post');?>" method="post" class="form-horizontal J_ajaxForms" enctype="multipart/form-data">
      ...
      <table class="table table-bordered">
            <tr>
              ...
              <select name="type" id="type">
                        <?php if(is_array($stotr_type)): foreach($stotr_type as $key=>$v): ?><option value="<?php echo ($v["id"]); ?>" <?php if($v['id'] == $type): ?>selected="selected"<?php endif; ?>><?php echo ($v["name"]); ?></option><?php endforeach; endif; ?>
                        </select>
              </td>
            </tr>
            <tr>
