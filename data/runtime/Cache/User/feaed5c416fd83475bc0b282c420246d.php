...
<body class="J_scroll_fixed">
	<div class="wrap J_check_wrap">
		<ul class="nav nav-tabs">
			<li class="active"><a href="javascript:;">话题列表</a></li>
			<li><a href="<?php echo U('Topic/add',array('type'=>$type));?>">添加话题</a></li>
		</ul>
		...
		<form class="form-horizontal J_ajaxForm" action="" method="post">
            ...
            <button class="btn btn-primary btn-small J_ajax_submit_btn" type="submit" data-action="<?php echo U('Topic/listorders');?>">排序</button>
            <input type="hidden" value="/info/index.php?g=User&m=Topic&a=index" name="nowUrl">
            </div>
		</form>
