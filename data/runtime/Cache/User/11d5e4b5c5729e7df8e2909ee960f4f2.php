...
<body class="J_scroll_fixed">
	<div class="wrap J_check_wrap">
		<ul class="nav nav-tabs">
			<li  class="active"><a href="javascript:;">试卷列表</a></li>
    <li><a href="<?php echo U('Subject/addExamination');?>">添加试卷</a></li>
		</ul>
			...
			<div class="search_type cc mb10">
				<div class="mb10">
				  ...
				  <script>
					function todo() {
						var month = $("#month").val();
						window.location.href='index.php?g=User&m=Subject&a=examinationIndex&menuid=185&month='+month;
					}
					</script>
				</div>
			</div>
		...
		<form class="form-horizontal J_ajaxForm" action="" method="post">
			<table class="table table-hover table-bordered">
				...
				<?php if(is_array($result)): foreach($result as $key=>$vo): ?><tr>
                    ...
                    <td><a href="<?php echo U('Subject/editExamination',array('id'=>$vo['id'],'month'=>$vo['month']));?>">修改</a> | <a href="<?php echo U('Subject/deleteExamination',array('id'=>$vo['id']));?>" class="J_ajax_del">删除</a>
					</td>
